...
namespace MaxyGames.UNode.Editors {
	public static class EditorBinding {
		...
		internal static Type syntaxHighlighter => "MaxyGames.UNode.SyntaxHighlighter.CSharpSyntaxHighlighter".ToType(false);
		internal static Type codeFormatter => "MaxyGames.UNode.Editors.CSharpFormatter".ToType(false);
